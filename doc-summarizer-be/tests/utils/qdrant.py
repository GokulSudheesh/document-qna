...
from core.models.completion_response import CompletionResponseWithReferences
from core.indexers.qdrant import doc_indexer
from core.chain.completion import chat_completion
...
async def get_similar_documents(query: str, filter: models.Filter) -> Tuple[list[Document] | None, str | None]:
    try:
        ...
        print(f"Error while extracting documents: {str(e)}")
